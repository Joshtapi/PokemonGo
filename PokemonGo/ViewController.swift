...
//  PokemonGo
//
//  Created by Joshua Tapia on 2/12/23.
//
...
class ViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    func setup() {
        ...
        Timer.scheduledTimer(withTimeInterval: 0.2, repeats: true, block: { (timer) in
            if let coord = self.ubicacion.location?.coordinate {
                ...
                let randomLat = (Double(arc4random_uniform(200))-100.0)/5000
                let randomLon = (Double(arc4random_uniform(200))-100.0)/5000
    ...
    func mapView(_ mapView: MKMapView, didSelect view: MKAnnotationView) {
        ...
        let region = MKCoordinateRegion.init(center: (view.annotation?.coordinate)!, latitudinalMeters: 1000, longitudinalMeters: 1000)
        mapView.setRegion(region, animated: true)
